...
class TestNoTrade(unittest.TestCase):
    def setUp(self):
        ...
        # سياق BTC متاح وإيجابي — القسم 12 من متطلبات V11 Final Patch:
        # BTC غائب يعني NO TRADE الآن (كان يمر بصمت سابقاً). "نظيف"
        # الحقيقي يعني بيانات BTC متوفرة وسليمة، لا مجرد غيابها.
